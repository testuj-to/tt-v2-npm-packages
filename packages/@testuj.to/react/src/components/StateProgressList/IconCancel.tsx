export interface IconCancelProps extends React.HTMLAttributes<SVGElement> {}

export const IconCancel = ({ ...props }: IconCancelProps) => {
    return (
        <svg
            {...props}
